'''
Training script for FUWAI_Cardiac
Copyright (c) Yushi LAN, 2020
'''
...
def main():
    ...
    transform_train = transforms.Compose([
        ...
        transforms.ToTensor(),
        transforms.Normalize((0.4914, 0.4822, 0.4465),  # ! TODO
    ...
    #     num_classes = 100
    trainset = CardiacDataset(
        datalist='train_list.txt', transform=transform_train)
